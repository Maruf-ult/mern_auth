...
function ResetPass() {
  ...
  const [isEmalSent,setIsEmailSent] = useState('')
      ...
      />
       ...
       {!isEmalSent &&  
        ...
        <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
         ...
         <button className="w-full py-2.5 bg-gradient-to-t from-indigo-500 to-indigo-900 text-white rounded-full mt-3 cursor-pointer ">Submit</button>
      
        </form>
}

      {!isOtpSubmited && isEmalSent && 
